...
const DICT_EN: ViewDict = {
  ...
  charts: {
    ...
    xAxisToStep: 'By step',
    xAxisToTime: 'By time',
    xAxisToBucket: 'By bucket',
    bucketSize: 'Window',
    bucketCustom: 'Custom',
    bucketHint: 'Each bar is the tokens burned in that window, bottom to top: cache hit, input, cache write, reasoning, answer',
...
const DICT_ZH: ViewDict = {
  ...
  charts: {
    ...
    bucketSize: '窗口',
    bucketCustom: '自定义',
    bucketHint: '每根柱子是该时段内消耗的 Token，自下而上：缓存命中、本次输入、缓存创建、思考、回答',
